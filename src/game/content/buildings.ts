...
const CANONICAL_BUILDING_SKINS: Record<BuildingSkinId, BuildingSkin> = {
  ...
  china_town_4: makeMonolithicBuilding("china_town_4", "structures/buildings/china_town/4", { heightUnits: 32 }),
  china_town_5: makeMonolithicBuilding("china_town_5", "structures/buildings/china_town/5", { heightUnits: 32 }),
  china_town_6: makeMonolithicBuilding("china_town_6", "structures/buildings/china_town/6", { heightUnits: 32, spriteScale: 2 }),
};
