...
export const AUTHORED_DELVE_PALETTE_ENTRIES: readonly AuthoredDelvePaletteEntry[] = [
  ...
  { paletteId: "fun_16", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  ...
  { paletteId: "midnight_ablaze", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "blessing", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "hollow", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "berry_nebula", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "cyclope6", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "bloodmoon21", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "blk_aqu4", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "dustbyte", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "hydrangea_11", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "fiery_plague_gb", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "leopolds_dreams", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "look_of_horror", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "aquaverse", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
  { paletteId: "sunraze", saturationWeight: 0.75, darkness: 0.5, enabledForRandomDelvePicker: true },
] as const;
